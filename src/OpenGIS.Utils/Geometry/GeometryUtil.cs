...
namespace OpenGIS.Utils.Geometry
{
    ...
    public static class GeometryUtil
    {
        ...
        /// 并集
        /// </summary>
        public static NetTopologySuite.Geometries.Geometry Union(NetTopologySuite.Geometries.Geometry a, NetTopologySuite.Geometries.Geometry b)
        {
            if (a == null || b == null)
                throw new ArgumentNullException(a == null ? nameof(a) : nameof(b));
        ...
        /// 多个几何对象合并
        /// </summary>
        public static NetTopologySuite.Geometries.Geometry Union(IEnumerable<NetTopologySuite.Geometries.Geometry> geometries)
        {
            if (geometries == null)
        ...
        /// 简化几何
        /// </summary>
        public static NetTopologySuite.Geometries.Geometry Simplify(NetTopologySuite.Geometries.Geometry geom, double tolerance)
        {
            if (geom == null)
                throw new ArgumentNullException(nameof(geom));
        ...
        public static NetTopologySuite.Geometries.Geometry Densify(NetTopologySuite.Geometries.Geometry geom, double distanceTolerance)
        {
            ...
            return NetTopologySuite.Densify.Densifier.Densify(geom, distanceTolerance);
        }
        ...
        public static TopologyValidationResult IsValid(NetTopologySuite.Geometries.Geometry geom)
        {
            ...
            if (!result.IsValid)
            {
                ...
                if (error != null)
                {
                    ...
                    result.ErrorLocation = error.Coordinate != null ? $"POINT ({error.Coordinate.X} {error.Coordinate.Y})" : null;
        ...
        public static SimpleGeometryResult IsSimple(NetTopologySuite.Geometries.Geometry geom)
        {
            ...
            var result = new SimpleGeometryResult
            {
            ...
            if (!result.IsSimple)
            {
                result.Reason = "Geometry has self-intersections or other complexity";
            }
        ...
        /// </summary>
        public static bool IsWithinDistance(NetTopologySuite.Geometries.Geometry a, NetTopologySuite.Geometries.Geometry b, double maxDistance)
        {
            if (a == null || b == null) return false;
